...
genforTesting = randi(9007199254740991);

extraBits = 1+(randi(2046));

queryID = uint64((genforTesting*extraBits)); %This one will be the input used
%for queries 
...
%A. Tag ID = 4567, ReaderID = 45678 

%B. Tag ID = 12345, ReaderID = 67890 

%C. Tag ID = 87654, ReaderID = 908762 

%D. Tag ID = 1, Reader ID = 99999 

%E. Tag ID = 902135, ReaderID = 23452 

 
%Generate a random numberfrom API of 0 to 18,446,744,073,709,551,615 
...
a = (randi(9007199254740991)*extraBits);

    %to create a base range of at least 16 bits
...
query = queryID; %use instead for unauthorized reader tests
...
  
findTag = bitxor(rPrime,returnQuery); %should give the API the correct tag ID
